...
export const ROUTE_METADATA: Record<string, PageMetadata> = {
  ...
  '/service/workflow': {
    title: 'لوما | ورکفلوها - بوم بصری ساخت فرآیندهای چندمرحلهای',
    description:
      'با ورکفلوهای لوما، فرآیندهای چندمرحلهای تولید محتوا را در یک بوم بصری طراحی و اجرا کنید.',
    ogTitle: 'لوما | ورکفلوها - بوم بصری ساخت فرآیندهای چندمرحلهای',
    ogDescription:
      'با ورکفلوهای لوما، فرآیندهای چندمرحلهای تولید محتوا را در یک بوم بصری طراحی و اجرا کنید.',
    ogType: 'website',
    twitterCard: 'summary',
    twitterTitle: 'لوما | ورکفلوها - بوم بصری ساخت فرآیندهای چندمرحلهای',
    twitterDescription:
      'با ورکفلوهای لوما، فرآیندهای چندمرحلهای تولید محتوا را در یک بوم بصری طراحی و اجرا کنید.',
  },
  '/solutions': {
  ...
  '/pricing': {
    title: 'لوما | تعرفهها و قیمتگذاری خدمات هوش مصنوعی',
    description:
      'تعرفهها و هزینه استفاده از ابزارهای هوش مصنوعی لوما را ببینید و اعتبار مورد نیاز خود را انتخاب کنید.',
    ogTitle: 'لوما | تعرفهها و قیمتگذاری خدمات هوش مصنوعی',
    ogDescription:
      'تعرفهها و هزینه استفاده از ابزارهای هوش مصنوعی لوما را ببینید و اعتبار مورد نیاز خود را انتخاب کنید.',
    ogType: 'website',
    twitterCard: 'summary',
    twitterTitle: 'لوما | تعرفهها و قیمتگذاری خدمات هوش مصنوعی',
    twitterDescription:
      'تعرفهها و هزینه استفاده از ابزارهای هوش مصنوعی لوما را ببینید و اعتبار مورد نیاز خود را انتخاب کنید.',
  },
  '/subscription': {
    title: 'لوما | پلنهای اشتراک',
    description:
      'پلنهای اشتراک لوما را مقایسه کنید و با انتخاب پلن مناسب، به ابزارهای هوش مصنوعی و اعتبار مورد نیاز خود دسترسی داشته باشید.',
    ogTitle: 'لوما | پلنهای اشتراک',
    ogDescription:
      'پلنهای اشتراک لوما را مقایسه کنید و با انتخاب پلن مناسب، به ابزارهای هوش مصنوعی و اعتبار مورد نیاز خود دسترسی داشته باشید.',
    ogType: 'website',
    twitterCard: 'summary',
    twitterTitle: 'لوما | پلنهای اشتراک',
    twitterDescription:
      'پلنهای اشتراک لوما را مقایسه کنید و با انتخاب پلن مناسب، به ابزارهای هوش مصنوعی و اعتبار مورد نیاز خود دسترسی داشته باشید.',
  },
  '/security': {
  ...
  '/gallery': {
    title: 'لوما | گالری نمونهکارهای هوش مصنوعی',
    description:
      'نمونهکارهای تولیدشده با ابزارهای هوش مصنوعی لوما را ببینید و با پرامپتهای استفادهشده برای خلق آنها آشنا شوید.',
    ogTitle: 'لوما | گالری نمونهکارهای هوش مصنوعی',
    ogDescription:
      'نمونهکارهای تولیدشده با ابزارهای هوش مصنوعی لوما را ببینید و با پرامپتهای استفادهشده برای خلق آنها آشنا شوید.',
    ogType: 'website',
    twitterCard: 'summary',
    twitterTitle: 'لوما | گالری نمونهکارهای هوش مصنوعی',
    twitterDescription:
      'نمونهکارهای تولیدشده با ابزارهای هوش مصنوعی لوما را ببینید و با پرامپتهای استفادهشده برای خلق آنها آشنا شوید.',
  },
  '/tutorials': {
