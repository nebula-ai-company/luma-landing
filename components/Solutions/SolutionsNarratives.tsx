...
const NARRATIVES: Narrative[] = [
  {
    ...
    icon: ShoppingBag,
    title: 'بهینه‌سازی تصاویر کاتالوگ فروشگاه در چند ثانیه',
    subtitle: 'کاهش هزینه‌های استودیویی و ارتقای چشمگیر تبدیل بازدیدکننده به خریدار',
    problem: 'هزینه سرسام‌آور استخدام عکاس و مدل، اجاره استودیوی تخصصی و تاخیر در ارائه کالا به بازار به دلیل فرآیند طولانی تدوین عکس‌ها.',
    workflow: [
      'آپلود مستقیم عکس ساده محصول عکاسی‌شده با موبایل.',
      'انتخاب پس‌زمینه دلخواه لوکس متناسب با زبان طراحی برند شما.',
      'پرو مجازی هوشمند بر روی اندام مدل‌های دیجیتالی متنوع بدون نیاز به عکاسی مجدد.',
      'بهینه‌سازی و ارتقای وضوح تصویر با استفاده از موتور بازسازی پیکسل.',
      'انتقال خروجی نهایی به صورت خودکار به CDN سایت فروشگاه.'
    ],
    tools: [
      { name: 'پرو مجازی هوشمند (Virtual Try-On)', path: '/service/try-on' },
      { name: 'حذف خودکار پیش‌زمینه (Bg Remove)', path: '/service/bg-remove' },
      { name: 'ارتقای کیفیت تصویر (Upscale)', path: '/service/upscale' }
    ],
    benefit: 'کاهش ۸۵٪ هزینه‌های عکاسی سنتی کاتالوگ، تسریع فرآیند معرفی محصول جدید به بازار به کمتر از ۱ ساعت و افزایش نرخ تبدیل خرید تا ۳۵٪.',
    integration: 'یکپارچه‌سازی وب از طریق افزونه‌های آماده وب‌سرویس یا API پیشرفته GraphQL با قابلیت آپلود اتوماتیک.',
  ...
  },
  {
    ...
    subtitle: 'خلق تصاویر برند محور سفارشی و تیزرهای تبلیغاتی بدون نیاز به تجهیزات فیلم‌برداری',
    ...
    workflow: [
      'ورود متن ساده ایده تبلیغاتی یا آپلود لوگو و محصول به عنوان مرجع فیزیکی.',
      'تولید خودکار ده‌ها اتود تصویری منحصربه‌فرد، بومی و هماهنگ با پالت رنگی برند.',
      'اعمال ویرایش‌های پیکسل-دقیق و درج هوشمند محصول در محیط بازسازی شده.',
      'تبدیل پوستر ایستا به تیزر متحرک ۴ تا ۸ ثانیه‌ای پرجزئیات برای شبکه‌های اجتماعی.',
      'تولید نریشن صوتی تیزر و گفتار تبلیغاتی متناسب با لحن برند به کمک تبدیل متن به گفتار.'
    ],
    tools: [
      { name: 'تولید تصویر با هوش مصنوعی (Image Gen)', path: '/service/img-gen' },
      { name: 'تولید ویدیو از متن و عکس (Video Gen)', path: '/service/video' },
      { name: 'تبدیل متن به گفتار (Text to Speech)', path: '/service/text-to-speech' },
      { name: 'ویرایش جادویی (Inpainting)', path: '/service/img-edit' }
    ],
    benefit: 'سرعت بخشیدن به فرآیند طوفان ذهنی و طراحی کمپین‌ها تا ۱۰ برابر، قطع کامل هزینه‌های خرید اشتراک سایت‌های استاک خارجی و بهبود چشمگیر CTR کمپین‌ها.',
    integration: 'وب‌هووک‌های پیشرفته جهت اتصال خودکار پلتفرم مدیریت کمپین یا API تولید ویدیو و تصویر.',
  ...
  },
  {
    ...
    workflow: [
      'ثبت عکس باکیفیت از زاویه خالی سالن یا آپلود فایل سه‌بعدی اولیه.',
      'انتخاب سبک طراحی داخلی مد نظر (مدرن، مینی‌مال، اسکاندیناوی یا کلاسیک).',
      'تشخیص خودکار هندسه دیوارها، نور ورودی و زوایای فضا توسط مدل لوما.',
      'چیدمان واقع‌گرایانه انواع مبلمان، پرده و المان‌های دکوراتیو هماهنگ با ابعاد.',
      'تولید رندرهای نهایی و لینک اختصاصی پانورامای ۳۶۰ درجه تعاملی.'
    ],
    tools: [
      { name: 'چیدمان مجازی و ویرایش جادویی', path: '/service/img-edit' },
      { name: 'مدل بازسازی سه‌بعدی و پانوراما', path: '/service/workflow' }
    ],
    benefit: 'فروش و اجاره تا ۵۰٪ سریع‌تر ملک، حذف کامل هزینه‌های سنگین لجستیک مبلمان فیزیکی و ایجاد امکان سفارشی‌سازی فضا متناسب با سلیقه مشتری پیش از خرید.',
    integration: 'افزودن دکمه «چیدمان آنلاین» بر روی وب‌سایت املاک با استفاده از SDK وایت‌لیبل iframe.',
    proofTitle: 'پیش‌نمایش چیدمان مجازی هوشمند',
    ctaText: 'پیاده‌سازی در وب‌سایت املاک'
  },
  {
    id: 'education',
    name: 'آموزش و یادگیری',
    icon: BookOpen,
    title: 'توسعه نسل جدید محتوای آموزشی و چندرسانه‌ای',
    subtitle: 'تبدیل متن‌های پیچیده علمی به انیمیشن‌های چندرسانه‌ای تعاملی و پرمخاطب',
    problem: 'هزینه تولید محتوای گرافیکی و ویدیویی برای یادگیری آنلاین بسیار بالاست و متن‌های ساده و طولانی منجر به کاهش نرخ تعامل و خستگی دانش‌آموزان می‌شود.',
    workflow: [
      'آپلود متن درسی، جزوه علمی یا محتوای تخصصی متنی.',
      'استخراج مفاهیم کلیدی و تقسیم‌بندی سناریوی آموزشی توسط هوش مصنوعی.',
      'تولید تصاویر گویا، اینفوگرافیک‌ها و تصاویر سه‌بعدی توصیفی منطبق با متن.',
      'تولید ویدیوهای انیمیشن متحرک جهت توضیح بصری پدیده‌های علمی پیچیده.',
      'تولید فایل صوتی با صدای طبیعی اساتید و سنتز گفتار هماهنگ با اسلایدها.'
    ],
    tools: [
      { name: 'دستیار هوشمند چت و تولید محتوا', path: '/service/chat' },
      { name: 'تبدیل متن به گفتار (Text to Speech)', path: '/service/text-to-speech' },
      { name: 'تولید ویدیوهای متحرک آموزشی', path: '/service/video' },
      { name: 'ارتقای بصری اسناد و اسلایدها', path: '/service/upscale' }
    ],
    benefit: 'افزایش ۶۰ درصدی تمایل کاربران به اتمام دوره‌ها، صرفه‌جویی عظیم در هزینه‌های فنی ساخت ویدیوهای آموزشی و چندزبانه کردن خودکار آموزش‌ها.',
    integration: 'یکپارچه‌سازی استاندارد با سیستم‌های آموزش الکترونیک (LMS) از طریق پروتکل‌های LTI و API اختصاصی.',
    proofTitle: 'پیش‌نمایش یادگیری بصری هوشمند',
    ctaText: 'تحول سیستم آموزشی'
  },
  {
    id: 'workflows',
    ...
    tools: [
      ...
      { name: 'دستیار چت هوشمند سازمانی', path: '/service/assistant' }
    ],
    benefit: 'کاهش ۹۵ درصدی خطاهای ناشی از پردازش دستی اطلاعات، کاهش هزینه‌های پرسنلی تکراری و افزایش سرعت پاسخگویی به مشتریان از چند روز به چند ثانیه.',
    integration: 'قابل ارائه در قالب کانتینر اختصاصی داکر جهت استقرار امن در سرورهای ابری یا محلی سازمان.',
