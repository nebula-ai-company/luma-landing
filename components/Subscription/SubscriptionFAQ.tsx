  ...
  const faqData: FaqItem[] = [
    {
      ...
      answer: "اشتراک ماهانه قابلیت‌های استودیویی لوما (مانند رندر پیشرفته، حفظ سوژه چندمرجع، پردازش همزمان بالا و خروجی ۱۰۸۰p) را برای اکانت شما فعال کرده و شامل مقداری لومِ هدیه است. اعتبار لوم (LUM) سوخت مصرفی موتورهای خلاقیت است که بابت هر ثانیه ویدیو یا هر تصویر تولیدی کسر می‌شود."
    },
    {
      question: "آیا حجم لومِ هدیه اشتراک به دوره یا ماه بعد منتقل می‌شود؟",
      answer: "خیر، لوم‌های اهدایی همراه اشتراک فقط برای همان دوره معتبر هستند و با شروع دوره بعدی ریست می‌شوند؛ اما هرگونه اعتبار لوم مجزا که خریداری کرده‌اید دائمی بوده و هرگز منقضی نمی‌شود. همچنین در طول فعال بودن اشتراک، خرید لوم‌های آزاد اضافی مشمول درصد تخفیف ویژه پلن شما خواهد بود."
    },
    {
