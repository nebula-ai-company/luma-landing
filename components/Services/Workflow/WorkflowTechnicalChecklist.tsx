...
const CHECKLIST_ITEMS: ChecklistItem[] = [
  ...
  },
  {
    ...
    details: [
      ...
      'گام ساخت و ویرایش تصویر: تولید تصویر و ویرایش پیشرفته با پرچمداران گرافیکی',
      'گام تبدیل متن به گفتار (TTS): پشتیبانی از Gemini 3.1 Flash TTS، ElevenLabs Eleven v3، MiniMax Speech 2.8 Turbo و HD',
      'گام ابزارهای لوما: حذف پس‌زمینه، افزایش کیفیت تصویر و پرو لباس',
  ...
  },
  {
    ...
    details: [
      'هزینه کل اجرا برابر است با مجموع اعتبار مصرفی بخش‌های فعال در پردازش',
      'امکان مشاهده تخمین هزینه پیش از شروع اجرای کامل روی بوم',
      'تثبیت و کسر هزینه واقعی پس از اتمام موفق پردازش نودها',
