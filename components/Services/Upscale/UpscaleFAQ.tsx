...
import { HelpCircle, ChevronDown, Sparkles, Zap, ExternalLink } from 'lucide-react';
...
const FAQS: FAQItem[] = [
  {
    q: "افزایش کیفیت و رزولوشن تصویر (Upscaling) چگونه کار می‌کند؟",
    a: "الگوریتم‌های هوش مصنوعی فوق‌پیشرفته لوما فراتر از یک بزرگ‌نمایی ساده عمل می‌کنند؛ آن‌ها با تحلیل ساختار تصویر، پیکسل‌های جدید تولید کرده و بافت‌های از دست رفته (مانند پارچه، پوست، جزییات چشم و لبه اشیاء) را بازسازی می‌کنند."
  },
  {
    q: "تفاوت مدل‌های مختلف نظیر Topaz، Clarity Crystal و Nano Banana Pro چیست؟",
    a: "مدل Topaz استاندارد طلایی صنعت عکاسی و چاپ است. Clarity Crystal بافت واقعی عکس را بدون تغییر چهره حفظ می‌کند. Clarity Creative بافت‌های جدیدی خلق کرده و برای تصاویر کم‌کیفیت عالی است. Nano Banana Pro امکان تنظیم دقیق رزولوشن نهایی (1K, 2K, 4K) را فراهم می‌آورد."
  },
  {
    q: "حداکثر ابعاد و کیفیت خروجی چقدر است؟",
    a: "شما می‌توانید رزولوشن تصاویر خود را تا 4K و در مدل‌های تخصصی برای چاپ تا 10K افزایش دهید که کاملاً آماده چاپ روی شاسی، بنر و بیلبوردهای غول‌پیکر است."
  },
  {
    q: "فرمت‌های تصویری ورودی و خروجی پشتیبانی‌شده کدامند؟",
    a: "تمامی فرمت‌های تصویری رایج شامل JPG، PNG، WebP و HEIC پشتیبانی می‌شوند و خروجی نهایی با کیفیت شفاف PNG یا JPG دانلود می‌گردد."
  },
  {
    q: "محاسبه هزینه و اعتبارات به چه صورت است؟",
    a: "هزینه بزرگ‌نمایی بر اساس مدل انتخابی و ضریب بزرگ‌نمایی یا رزولوشن خروجی محاسبه می‌شود. برای مشاهده دقیق اعتبارات و بسته‌ها می‌توانید به استودیو لوما مراجعه نمایید."
  }
];

export const UpscaleFAQ: React.FC = () => {
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-20">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-bold text-zinc-900 dark:text-white text-sm">آماده افزایش کیفیت تصاویر خود هستید؟</h4>
              <p className="text-xs text-zinc-500 dark:text-gray-400 mt-0.5">وارد استودیو شوید و تصاویر خود را با رزولوشن 4K دانلود کنید.</p>
            </div>
          </div>
          <a
