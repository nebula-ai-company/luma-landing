...
const FAQS: FAQItem[] = [
  {
    ...
    a: "الگوریتم‌های هوش مصنوعی لوما با تحلیل ساختار بصری تصویر، وضوح لبه‌ها را بهبود داده و بافت‌های تصویر را به شکلی طبیعی ارتقا و بازسازی می‌کنند."
  },
  {
    q: "تفاوت مدل‌های مختلف پردازش تصویر در لوما چیست؟",
    a: "مدل‌های وفادار نظیر Topaz Precision و Clarity Crystal ساختار تصویر را با کمترین تغییر حفظ می‌کنند. مدل‌های بازسازی نظیر Topaz Restore و Topaz Generative برای عکس‌های آسیب‌دیده یا بازسازی بافت مناسبند. مدل‌هایی نظیر SeedVR2 بزرگ‌نمایی تا ۱۰ برابر را فراهم می‌آورند و Nano Banana Pro امکان تعیین مستقیم رزولوشن نهایی (1K, 2K, 4K) را در اختیار شما می‌گذارد."
  },
  {
    q: "حداکثر ابعاد و کیفیت خروجی چقدر است؟",
    a: "بسته به مدل انتخابی، می‌توانید رزولوشن تصاویر خود را تا 4K یا ضرایب بزرگ‌نمایی تا ۱۰ برابر افزایش دهید که برای خروجی‌های دیجیتال باکیفیت و مصارف چاپی مناسب است."
  },
  {
    q: "فرمت‌های تصویری ورودی و خروجی پشتیبانی‌شده کدامند؟",
    a: "فرمت‌های تصویری رایج شامل JPG، PNG و WebP پشتیبانی می‌شوند و فایل نهایی با کیفیت بالا و شفاف قابل دانلود است."
  },
  {
    q: "محاسبه هزینه و اعتبارات به چه صورت است؟",
    a: "هزینه پردازش بر اساس مدل انتخابی و تنظیمات رزولوشن یا بزرگ‌نمایی به صورت شفاف در استودیو لوما به لوم محاسبه می‌شود."
  }
];
