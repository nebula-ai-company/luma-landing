...
const INITIAL_FEATURES = [
  {
    id: 'details',
    icon: ScanLine,
    title: "بازیابی و ارتقای جزئیات",
    subtitle: "بازسازی بافت‌های تصویر",
    desc: "موتورهای پیشرفته هوش مصنوعی پیکسل‌ها را فقط بزرگ نمی‌کنند، بلکه بافت‌ها و جزئیات تحلیل‌رفته تصویر را به شکلی طبیعی بازسازی و تقویت می‌کنند.",
  ...
  },
  {
    id: 'fix',
    icon: Zap,
    title: "بهبود خروجی هوش مصنوعی",
    subtitle: "افزایش وضوح و رفع تاری",
    desc: "تصاویر تولید شده با هوش مصنوعی یا فایل‌های با وضوح پایین را به رزولوشن‌های بالاتر و شفافیت ایده‌آل ارتقا دهید.",
  ...
  },
  {
    ...
    subtitle: "حذف نویز و بهبود بافت",
    desc: "عکس‌های قدیمی، آسیب‌دیده یا نویزدار را اسکن و بارگذاری کنید تا با مدل‌های ترمیمی تخصصی، وضوح و بافت شفاف‌تری دریافت کنید.",
  ...
  },
  {
    id: 'print',
    icon: Printer,
    title: "آماده‌سازی برای چاپ و نمایش",
    subtitle: "افزایش رزولوشن و شارپنس",
    desc: "عکس‌های با ابعاد کوچک را برای چاپ یا نمایش باکیفیت آماده کنید. موتورهای وفادار ساختار لبه‌ها و وضوح را به شکلی پایدار حفظ می‌کنند.",
