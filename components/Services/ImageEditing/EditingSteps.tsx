...
const STEPS = [
  ...
  },
  {
    ...
    desc: "از میان ۱۷ مدل هوش مصنوعی مانند Flux 2، Qwen Edit و Nano Banana مناسب‌ترین را برای هدف خود برگزینید.",
  ...
  },
  {
    ...
    desc: "تصویر ویرایش‌شده را با رزولوشن تا 4K و در نسبت‌های ابعادی مختلف مشاهده و ذخیره کنید.",
