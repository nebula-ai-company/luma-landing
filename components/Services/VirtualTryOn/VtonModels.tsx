...
const MODELS = [
    { 
        ...
        bg: "bg-luma-yellow/5 dark:bg-[#1a1a1a]",
        icon: Crown
    },
    { 
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                {MODELS.map((model, i) => (
                    ...
                    >
                        ...
                        <h3 className="text-lg font-bold text-zinc-900 dark:text-white mb-3 group-hover:text-zinc-700 dark:group-hover:text-gray-200 transition-colors">
                            {model.name}
                        </h3>
                        <p className="text-sm text-zinc-600 dark:text-gray-400 leading-relaxed mb-6 flex-1">
                            {model.desc}
                        </p>
