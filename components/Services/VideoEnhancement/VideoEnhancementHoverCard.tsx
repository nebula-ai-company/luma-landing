...
interface VideoEnhancementHoverCardProps {
  children: React.ReactNode;
  accentColor?: 'purple' | 'pink' | 'yellow';
  className?: string;
...
export const VideoEnhancementHoverCard: React.FC<VideoEnhancementHoverCardProps> = ({
  children,
  accentColor = 'purple',
  className = '',
  innerClassName = '',
  ...
  const colorHex = BRAND_COLORS[accentColor] || BRAND_COLORS.purple;
