...
export const GenSteps: React.FC = () => {
  return (
    <section className="py-32 bg-[#0a0a0a] relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 right-0 h-48 bg-gradient-to-b from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent z-10 pointer-events-none" />
      <div className="absolute bottom-0 left-0 right-0 h-48 bg-gradient-to-t from-[#0a0a0a] via-[#0a0a0a]/80 to-transparent z-10 pointer-events-none" />
      ...
      <div className="max-w-screen-2xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-24">
           ...
           >
              ...
              <span className="text-gray-300 font-bold text-xs tracking-wide uppercase">فرآیند تولید</span>
           </motion.div>
        ...
        <div className="relative">
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-6">
              {STEPS.map((step, idx) => (
                 ...
                 >
                    {/* Card Container */}
                    <div className="h-full bg-[#121212] border border-white/5 rounded-[32px] p-6 pt-10 relative overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:border-white/10 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.5)] flex flex-col items-center text-center">
                       ...
                       {/* Step Number Badge */}
                       <div className="absolute top-4 right-4 text-[10px] font-bold text-gray-600 bg-white/5 px-2 py-1 rounded-full border border-white/5 group-hover:text-white group-hover:border-white/20 transition-colors">
                          STEP {step.id}
                       </div>
                       ...
                       <div className="relative mb-8">
                          <div 
                             className="w-20 h-20 rounded-2xl bg-[#1a1a1a] border border-white/5 flex items-center justify-center shadow-lg transition-transform duration-500 group-hover:scale-110 group-hover:rotate-3 relative z-10"
                       ...
                       <div className="lg:hidden absolute -bottom-6 left-1/2 -translate-x-1/2 text-white/10">
