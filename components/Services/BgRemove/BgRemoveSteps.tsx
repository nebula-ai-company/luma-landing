...
import { UploadCloud, Wand2, Zap, CheckCircle2 } from 'lucide-react';
      ...
      <div className="max-w-screen-2xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-24 relative">
           <motion.div 
             ...
             viewport={{ once: true }}
             className="inline-block px-4 py-1.5 rounded-full border border-white/10 bg-white/5 backdrop-blur-md text-xs font-bold text-gray-300 mb-8"
           >
              ساده‌ترین فرآیند
           </motion.div>
           ...
           <div className="w-full overflow-hidden">
             <p className="text-gray-400 text-lg md:text-xl font-light whitespace-nowrap overflow-visible min-w-full text-center">
        ...
        <div className="relative max-w-5xl mx-auto">
           ...
           <div className="absolute top-12 left-[16.5%] right-[16.5%] h-px bg-white/10 hidden md:block overflow-hidden">
              <motion.div 
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8 relative">
              ...
              <div className="relative group">
                 <div className="flex flex-col items-center text-center">
                    <motion.div 
                       className="w-24 h-24 rounded-full bg-[#111] border border-white/10 flex items-center justify-center relative z-10 shadow-[0_0_40px_-10px_rgba(255,255,255,0.1)] group-hover:border-luma-purple/50 transition-colors duration-500"
                    ...
                    >
                       ...
                       <UploadCloud size={32} className="text-gray-400 group-hover:text-luma-purple transition-colors" />
                    ...
                    <div className="mt-8 relative z-10">
                       <h3 className="text-xl font-bold text-white mb-2">بارگذاری تصویر</h3>
                       <p className="text-sm text-gray-500 max-w-[200px] mx-auto leading-6">
              ...
              <div className="relative">
                 <div className="flex flex-col items-center text-center">
                    <div className="relative w-24 h-24 flex items-center justify-center z-10">
                       ...
                       <div className="w-16 h-16 bg-[#111] rounded-full flex items-center justify-center border border-white/10 shadow-[0_0_50px_rgba(255,255,255,0.1)]">
                          <Zap size={24} className="text-white animate-pulse" />
                       </div>

                       {/* Connectors (Mobile) */}
                       <div className="md:hidden absolute top-full left-1/2 -translate-x-1/2 h-12 w-px bg-gradient-to-b from-white/20 to-transparent" />
                       <div className="md:hidden absolute bottom-full left-1/2 -translate-x-1/2 h-12 w-px bg-gradient-to-t from-white/20 to-transparent" />
                    </div>
              ...
              <div className="relative group">
                 <div className="flex flex-col items-center text-center">
                    <motion.div 
                       className="w-24 h-24 rounded-full bg-[#111] border border-white/10 flex items-center justify-center relative z-10 shadow-[0_0_40px_-10px_rgba(255,255,255,0.1)] group-hover:border-luma-pink/50 transition-colors duration-500"
                       whileHover={{ scale: 1.1 }}
                    >
                       <div className="absolute inset-0 rounded-full bg-luma-pink/5 blur-xl opacity-0 group-hover:opacity-100 transition-opacity" />
                       <CheckCircle2 size={32} className="text-gray-400 group-hover:text-luma-pink transition-colors" />
                    ...
                    <div className="mt-8 relative z-10">
                       <h3 className="text-xl font-bold text-white mb-2">دریافت خروجی</h3>
                       <p className="text-sm text-gray-500 max-w-[200px] mx-auto leading-6">
