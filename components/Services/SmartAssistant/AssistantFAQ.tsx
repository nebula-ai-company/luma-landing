...
import { HelpCircle, ChevronDown, Bot, Zap, ExternalLink } from 'lucide-react';
...
const FAQS: FAQItem[] = [
  {
    q: "چگونه اطلاعات و مستندات کسب‌وکارم را به دستیار هوشمند اضافه کنم؟",
    a: "شما می‌توانید به راحتی فایل‌های PDF، Word، Excel و متون خود را بارگذاری کنید یا آدرس وب‌سایت خود را وارد نمایید. سیستم هوشمند لوما به طور خودکار محتوا را پردازش، خلاصه‌سازی و بسته‌بندی کرده و پایگاه دانش دستیار شما را آماده می‌سازد."
  },
  {
    q: "آیا برای اتصال دستیار به وب‌سایت نیاز به دانش کدنویسی دارم؟",
    a: "خیر، هیچ‌گونه دانش فنی یا کدنویسی نیاز نیست. شما می‌توانید با کپی کردن یک اسکریپت ساده تک‌خطی ویجت چت را به سایت خود اضافه کنید، یا از آدرس اختصاصی (Dedicated Link) برای اشتراک‌گذاری در شبکه‌های اجتماعی استفاده نمایید."
  },
  {
    q: "تفاوت مدل‌های هوش مصنوعی متصل به دستیار چیست؟",
    a: "مدل‌های پرچم‌دار مانند GPT-5 و GPT-4o برای استدلال‌های پیچیده و تحلیل‌های عمیق عالی هستند. مدل‌های سری mini و nano پاسخ‌دهی فوق‌العاده سریع با مصرف اعتبار بسیار پایین‌تر را ارائه می‌دهند که برای پاسخ به سوالات متداول مشتریان بسیار اقتصادی هستند."
  },
  {
    q: "آیا دستیار هوشمند لوما بر زبان فارسی تسلط کامل دارد؟",
    a: "بله، دستیار هوشمند لوما پشتیبانی نیتیو و روان از زبان فارسی دارد و می‌توانید لحن پاسخ‌گویی آن را متناسب با هویت برند خود (رسمی، دوستانه، صمیمی یا طنز) تنظیم کنید."
  },
  {
    q: "میزان مصرف اعتبار و هزینه‌های دستیار چگونه محاسبه می‌شود؟",
    a: "هزینه هر پیام بر اساس مدل هوش مصنوعی انتخابی شما محاسبه می‌گردد. همچنین طرح رایگان برای تست و ۵۰ پیام اول بدون نیاز به پرداخت در اختیار شماست."
  }
];

export const AssistantFAQ: React.FC = () => {
    ...
    <section className="py-24 bg-[#FAFAFA] dark:bg-[#0a0a0a] relative overflow-hidden transition-colors duration-300 font-sans" dir="rtl">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-20">
        ...
        <div className="text-center mb-16">
          ...
          >
            پاسخ به سوالات رایج درباره راه‌اندازی، اتصال و هزینه‌های دستیار هوشمند لوما.
          </motion.p>
        </div>
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-12 p-6 rounded-2xl bg-gradient-to-r from-luma-yellow/10 via-luma-purple/5 to-transparent border border-luma-yellow/20 flex flex-col sm:flex-row items-center justify-between gap-4 text-center sm:text-right"
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h4 className="font-bold text-zinc-900 dark:text-white text-sm">آماده ساخت کارمند دیجیتال خود هستید؟</h4>
              <p className="text-xs text-zinc-500 dark:text-gray-400 mt-0.5">همین حالا به صورت رایگان دستیار هوشمند خود را در استودیو ایجاد کنید.</p>
            </div>
          </div>
          <a
